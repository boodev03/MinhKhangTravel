...
export default function Car16() {
  ...
  return (
    <>
      <SEOConfig
        title="Thuê xe 16 chỗ - MinhKhangTravel - Dịch vụ xe tiện lợi cho nhóm lớn"
        description="MinhKhangTravel cung cấp dịch vụ thuê xe 16 chỗ cho các đoàn du lịch và sự kiện. Xe rộng rãi, tiện nghi, phù hợp cho các nhóm lớn và gia đình."
        keywords="thuê xe 16 chỗ, thuê xe ô tô 16 chỗ, MinhKhangTravel, thuê xe nhóm lớn, thuê xe du lịch, dịch vụ thuê xe 16 chỗ Việt Nam"
      />
