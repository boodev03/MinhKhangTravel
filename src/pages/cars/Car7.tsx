...
const CarDetail = CarDetails.find((CarDetail) => CarDetail.id === 2);
const car = carsType.find((cartype) => cartype.id === 2);
...
export default function Car7() {
  ...
  return (
    <>
      <SEOConfig
        title="Thuê xe 7 chỗ - MinhKhangTravel - Xe rộng rãi cho gia đình và nhóm nhỏ"
        description="Dịch vụ cho thuê xe 7 chỗ tại MinhKhangTravel, phù hợp cho các chuyến du lịch gia đình hoặc nhóm nhỏ. Xe 7 chỗ thoải mái, tiết kiệm và an toàn."
        keywords="thuê xe 7 chỗ, thuê xe ô tô 7 chỗ, MinhKhangTravel, thuê xe gia đình, thuê xe nhóm, dịch vụ thuê xe 7 chỗ Việt Nam"
      />
