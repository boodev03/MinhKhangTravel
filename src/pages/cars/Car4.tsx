...
const CarDetail = CarDetails.find((CarDetail) => CarDetail.id === 1);
const car = carsType.find((cartype) => cartype.id === 1);
...
export default function Car4() {
  ...
  return (
    <>
      <SEOConfig
        title="Thuê xe 4 chỗ - MinhKhangTravel - Dịch vụ cho thuê xe uy tín tại Việt Nam"
        description="Dịch vụ cho thuê xe 4 chỗ tại MinhKhangTravel, phù hợp cho gia đình nhỏ và các chuyến đi công tác. Xe đời mới, tiện nghi, giá cả hợp lý."
        keywords="thuê xe 4 chỗ, thuê xe ô tô 4 chỗ, MinhKhangTravel, thuê xe gia đình, dịch vụ thuê xe 4 chỗ Việt Nam"
      />
