...
const CarDetail = CarDetails.find((CarDetail) => CarDetail.id === 4);
const car = carsType.find((cartype) => cartype.id === 4);
...
export default function Car29() {
  const [hoveredCard, setHoveredCard] = useState<number | null>(null);
  const [isModalOpen, setIsModalOpen] = useState<boolean>(false);
  return (
    <>
      <SEOConfig
        title="Thuê xe 29 chỗ - MinhKhangTravel - Xe phục vụ tour và đoàn lớn"
        description="Dịch vụ cho thuê xe 29 chỗ tại MinhKhangTravel, thích hợp cho các đoàn lớn và tour du lịch. Xe chất lượng cao, thoải mái, an toàn và tiện nghi."
        keywords="thuê xe 29 chỗ, thuê xe ô tô 29 chỗ, MinhKhangTravel, thuê xe tour, thuê xe đoàn lớn, dịch vụ thuê xe 29 chỗ Việt Nam"
      />
